...
public class MyStringList {
	...
	public static void main(String[] args) {
		...
		System.out.println("Search Result for keyword number " + l.search("number"));
		System.out.println("Search Result for keyword tiny " + l.search("tiny"));
