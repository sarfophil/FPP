...
public class Prog3 {
	...
	public static void main(String[] args) {
        ...
        for(int i = 0; i < splittedRecords.length; i++){
            //Split each product with the help of the index
            String[] product = splittedRecords[i].split(",");

            //Since product Id is the beginning of every product. I will display the product Id at index 0
